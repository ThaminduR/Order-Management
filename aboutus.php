	...
	<div class="aboutus container-fluid">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<h3>Mission</h3>
				<li>Energize and enhance personality through our passion for world-class innovative menswear solutions</li>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="footer-menu">
				...
				<a href="aboutus.php" class="active-link">About Us</a>
